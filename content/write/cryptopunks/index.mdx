...
I have written a <Link to="../cryptopunks-technical">technical explainer</Link> as a companion to this piece, which goes into more depth regarding certain topics.
