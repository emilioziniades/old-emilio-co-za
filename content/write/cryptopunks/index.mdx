...
I have written a [technical explainer](../cryptopunks-technical) as a companion to this piece, which goes into more depth regarding certain topics.
...
I make use of two economic concepts to conduct this analysis: Lorenz curves and Gini coefficients. For more information, see the [technical explainer](../cryptopunks-technical).
